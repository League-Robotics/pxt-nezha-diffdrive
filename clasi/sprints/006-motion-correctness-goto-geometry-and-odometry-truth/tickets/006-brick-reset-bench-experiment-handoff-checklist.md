...
- [ ] `brick-reset-odometry-teleport.md` (the issue file, now living
...
- [ ] The checklist states plainly what a "confirmed" vs. "ruled out"
...
- [ ] The checklist references ticket 005's shipped fix by name/path
...
- [ ] Ticket frontmatter's `depends-on: ['005']` reflects the real
