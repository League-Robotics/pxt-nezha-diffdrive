...
# The two chunks emitHelp() splits today's 18-verb table into. Kept as
# module constants because every HELP test below asserts the same pair.
_HELP_L1 = b"help HELLO PING ID VER STATUS HELP GET SET TLM WHEELS_X\n"
_HELP_L2 = b"help WHEELS_V MOVE_X MOVE_V GO_TO_R GO_TO_W STOP ESTOP RUN\n"
_HELP = _HELP_L1 + _HELP_L2
