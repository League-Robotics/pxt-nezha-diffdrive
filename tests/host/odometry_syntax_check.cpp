// odometry_syntax_check.cpp -- dedicated compile-only translation unit
// giving tests/host/test_cxx11_syntax_gate.py something to point a
// -fsyntax-only -std=c++11 compile at directly.
//
// src/motion/odometry.h is a pure header with no natural .cpp of its own
...
// tests/host/odometry_shim.cpp for that.
