...
LIMX = 55.0; YMIN, YMAX = -32.6, 32.6   # whole field (stakeholder 13:20)
HARDX, HARDYN, HARDYS = 61.0, 40.0, -40.0
...
json.dump({'args': sys.argv[1:], 'side_mm': SIDE, 'laps': laps, 'log': LOG}, open(OUT + 'g6-run-500.json', 'w'), indent=1)
